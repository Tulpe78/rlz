...
@WebServlet(urlPatterns = { "/addAthlet" })
public class AddMyAthletServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
 
    public AddMyAthletServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            AthletDAO.addAthlet(conn, Integer.parseInt(idStr));
